...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[tensorflow_dot_core_dot_framework_dot_attr__value__pb2.DESCRIPTOR,tensorflow_dot_core_dot_framework_dot_full__type__pb2.DESCRIPTOR,])
...
_NODEDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='experimental_type', full_name='tensorflow.NodeDef.experimental_type', index=6,
...
_NODEDEF.fields_by_name['experimental_type'].message_type = tensorflow_dot_core_dot_framework_dot_full__type__pb2._FULLTYPEDEF
